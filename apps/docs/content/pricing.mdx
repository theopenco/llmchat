...
| ----------- | ------------------------- | ------------------------ | --------------- | -------- | --------- | ----------- | ----------------------- |
| **Starter** | %%PRICE_STARTER_MONTHLY%% | %%PRICE_STARTER_ANNUAL%% | 2,000           | 2        | 3         | Basic class | "Powered by" badge      |
| **Growth**  | %%PRICE_GROWTH_MONTHLY%%  | %%PRICE_GROWTH_ANNUAL%%  | 12,000          | 5        | 10        | All models  | No badge                |
| **Scale**   | %%PRICE_SCALE_MONTHLY%%   | %%PRICE_SCALE_ANNUAL%%   | 50,000          | 20       | Unlimited | All models  | Custom branding allowed |
