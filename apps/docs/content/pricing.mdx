...
All hosted plans are currently **50% off** — the struck-through figures are the regular prices.

| Plan        | Monthly          | Annual               | AI responses/mo | Projects | Seats     | Models      | Branding                |
| ----------- | ---------------- | -------------------- | --------------- | -------- | --------- | ----------- | ----------------------- |
| **Starter** | ~~$19~~ $9.50    | ~~$190~~ $95/yr      | 2,000           | 2        | 3         | Basic class | "Powered by" badge      |
| **Growth**  | ~~$89~~ $44.50   | ~~$890~~ $445/yr     | 12,000          | 5        | 10        | All models  | No badge                |
| **Scale**   | ~~$299~~ $149.50 | ~~$2,990~~ $1,495/yr | 50,000          | 20       | Unlimited | All models  | Custom branding allowed |
