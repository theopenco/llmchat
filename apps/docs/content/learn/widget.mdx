...
| **Agent photo**        | URL of a photo or logo shown on the launcher bubble and the chat header, so the widget carries your team's face; leave blank for the default icon                          |
