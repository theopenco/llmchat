// Canonical cross-app URLs for the docs app — one place instead of a
// hardcoded string per route handler. The docs host is fixed (this app *is*
// docs.clankersupport.com), so these are plain constants, not env reads.
