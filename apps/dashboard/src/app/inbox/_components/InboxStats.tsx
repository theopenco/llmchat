...
function StatCard({
	...
	return (
		<div className="rounded-[10px] border border-ck-border bg-ck-card px-3 py-2 text-center">
			<div
				className={cn(
					"flex items-center justify-center gap-1 text-lg font-semibold leading-none tabular-nums",
