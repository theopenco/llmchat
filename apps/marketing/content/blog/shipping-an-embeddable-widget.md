...
All of this code is public — the widget, the stub, both Dawn fixes with their commit messages — in the [repo](https://github.com/theopenco/llmchat), and you can poke the live widget in the chat bubble on [our homepage](https://clankersupport.com). If you're building your own embed, steal the rules; we already paid for them, one Dawn dev store at a time.
